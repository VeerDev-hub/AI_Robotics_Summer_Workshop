...
export function SignupView({ onSuccess, onSwitchToLogin, onGoHome }: SignupViewProps) {
  ...
  return (
    <div className="min-h-screen py-16 px-4 flex items-center justify-center relative overflow-hidden" style={{ background: 'var(--grad-hero)' }}>
      ...
      <div className="absolute top-10 left-10 w-24 h-24 rounded-full bg-pink-400/10 pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-36 h-36 rounded-full bg-yellow-400/10 pointer-events-none" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input 
              ...
              placeholder="e.g. RoboSlayer"
              required
              className="w-full px-4 py-2 rounded-xl border-3 border-slate-900 font-semibold focus:outline-none focus:ring-2 focus:ring-orange-500 bg-white"
              style={{ 
                color: 'var(--clr-ink)', 
